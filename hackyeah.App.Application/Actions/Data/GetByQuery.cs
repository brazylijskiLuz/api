...
{
    public sealed record Command(string query, int page) : IRequest<List<UniversityData>>;
    ...
    public class Handler : IRequestHandler<Command, List<UniversityData>>
    {
        ...
        public Task<List<UniversityData>> Handle(Command request, CancellationToken cancellationToken) =>
            _unitOfWork.UniversityData.GetByQueryAsync(request.query, request.page, _pageSize, cancellationToken);
