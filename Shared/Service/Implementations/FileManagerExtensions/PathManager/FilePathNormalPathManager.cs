...
public class FilePathNormalPathManager : IFilePathManager
{
    private readonly string _imageExtension;
    private readonly string _imagePath;
    private const string MinifiedImageName = "-min";
    public FilePathNormalPathManager(IConfiguration configuration)
    {
    ...
    public string FactoryFilePath(ImageType imageType, Guid imageId) => $"{_imagePath}/{DictionaryNames.Dictionary[imageType]}/{imageId}.{_imageExtension}";
    public string FactoryLocalFilePath(ImageType imageType, Guid imageId) => $"{DictionaryNames.Dictionary[imageType]}-{imageId}.{_imageExtension}";
}